    ...
    <div class="container">
        <div class="row">
            <div class="{{ $product_section_width }} {{ $sidebar_position }}">
                ...
                @else
                    <div class="alert alert-danger d-flex justify-content-between">{{__('no products found')}} <a href="{{route('frontend.products.all')}}" class="btn btn-warning btn-xs">{{__('reset filter')}}</a></div>
                @endif
