...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode']], function () {
    ...
    ---------------------------------*/
    Route::get('filter-top-rated', 'FrontendController@topRatedProducts')->name('frontend.products.filter.top.rated');
    Route::get('filter-top-selling', 'FrontendController@topSellingProducts')->name('frontend.products.filter.top.selling');
    Route::get('filter-new', 'FrontendController@newProducts')->name('frontend.products.filter.new');
    ...
    Route::group(['prefix' => $product_page_slug, 'as' => 'frontend.products.'], function () use ($product_page_slug) {
        ...
        Route::get('category/{id}/{any?}', 'FrontendController@products_category')->name('category');
