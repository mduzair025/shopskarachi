...
<?php endif; ?>
                ...
                <?php else: ?>
                    <div class="alert alert-danger d-flex justify-content-between"><?php echo e(__('no products found')); ?> <a href="<?php echo e(route('frontend.products.all')); ?>" class="btn btn-warning btn-xs"><?php echo e(__('reset filter')); ?></a></div>
                <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\MDUZAIR\zaika\@mdcore\resources\views/frontend/product/all.blade.php ENDPATH**/ ?>