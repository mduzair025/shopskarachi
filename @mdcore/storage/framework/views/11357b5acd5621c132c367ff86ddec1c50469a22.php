                        ...
                        <?php if($product_image_gallery && count($product_image_gallery)): ?>
                            ...
                            <div class="single-main-image">
                                <?php if(!empty($product->badge)): ?>
                                    <span class="sale"><?php echo e($product->badge); ?></span>
                                <?php endif; ?>
                                <a href="<?php echo e(get_attachment_image_by_id($gallery_image, 'full')['img_url']); ?>" class="long-img magnific" data-key="<?php echo e($loop->iteration + 1); ?>">
                                    <i class="las la-search-plus"></i>
                                </a>
                                <figure class="zoom zoom-js-handle"
                    ...
                    <div class="user-select-option">
                        ...
                        <div class="product_related_info mt-5">
                            <?php if($item_in_stock): ?>
                                ...
                                <div class="text-success"><small>(<?php echo e($item_stock_count.' '.Str::of('item')->plural($item_stock_count). ' ' . __('available in stock')); ?>)</small></div>
                            <?php else: ?>
                                <div class="text-secondary text-danger"><small>(<?php echo e(__('Item is not available in stock')); ?>)</small></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="quantity-add-cart add_to_cart_info">
                            ...
                            <div class="quantity">
                                <div class="input-group">
                                    <input class="quantity form-control" id="quantity" type="number" min="1" max="10000000" value="1">
                                </div>
                            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="single-new-collection-item single-product-item">
                    ...
                    <div class="product-details-wrap">
                        <h3 class="product-title"><a href="<?php echo e(route('frontend.products.single', $product->slug)); ?>"><?php echo e(Str::limit($product->title, 23)); ?></a></h3>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\MDUZAIR\zaika\@mdcore\resources\views/frontend/product/details.blade.php ENDPATH**/ ?>